...
const Points = () =>{
    ...
    useEffect(() =>{
      async function loadPosition(){
        ...
        if(status !== 'granted'){
          Alert.alert('Opa....', 'Precisamos de sua permissão para ter a localização do seu dispositivo.')
          return
        }
    ...
    return (
        <>
            <View style={styles.container}>
                <TouchableOpacity>
                    <Icon name="arrow-left" size={20} color="#34cb79" onPress={handleNavigateHome}/>
                </TouchableOpacity>
